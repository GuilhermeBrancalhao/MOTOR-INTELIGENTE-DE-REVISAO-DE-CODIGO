...
Este volume descreve política e disciplina de instrumentação, não cita código executável
específico deste ciclo (ver `16-Roadmap.md`). Nenhuma seção deste volume tem
`<!-- exemplo: -->`.
